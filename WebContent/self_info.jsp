...
<header>
	<div class="top center">
		...
		<div class="right fr">
			<div class="gouwuche fr"><a href="XmOrderServlet?operate=xmorder&&pageChange=0">我的订单</a></div>
			<div class="fr">
				<ul>
					<li>${user.username }</li>
...
<div class="grzxbj">
	...
	<div class="lfnav fl">
		...
		<div class="subddzx">
			<ul>
				<li><a href="XmOrderServlet?operate=xmorder&&pageChange=0" >我的订单</a></li>
				<li><a href="">意外保</a></li>
				<li><a href="">团购订单</a></li>
				<li><a href="">评价晒单</a></li>
			</ul>
...
<div class="rtcont fr">
	<div class="grzlbt ml40">我的资料</div>
	<div class="subgrzl ml40"><span><a href="UserServlet?operate=edit&&uid=${user.uid}">编辑资料</a></span></div>
<div class="subgrzl ml40"><span>昵称</span><span>${user.username }</span></div>
<div class="subgrzl ml40"><span>手机号</span><span>${user.phonenumber }</span></div>
<div class="subgrzl ml40"><span>密码</span><span id="pwd">${user.password }</span></div>
...
<!-- self_info -->
  ...
  <script type="text/javascript">
  	 window.onload = function(){
  		...
  		pwd.innerHTML = pwd.innerHTML.charAt(0)+"***"+pwd.innerHTML.charAt(pwd.innerHTML.length-1);
  	 } 
  </script>
</html>
